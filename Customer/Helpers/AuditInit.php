...
/**
 * Customer মডিউলের জন্য Audit Logger বুটস্ট্র্যাপ।
 * bootstrap.php থেকে একবার AuditInit::boot($conn) কল করুন।
 */
final class AuditInit
{
    ...
    public static function boot(\PDO $conn): void
    {
        ...
        if (!is_file($auditDir . '/AuditLogModel.php') || !is_file($auditDir . '/AuditLogger.php')) {
            error_log('AuditInit (Customer): Audit module not found at ' . $auditDir);
            return;
        }
