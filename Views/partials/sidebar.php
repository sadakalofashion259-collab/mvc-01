 ...
 *   .round-3d-btn        → unified icon-badge button (see button-system.js)
 ...
 *   icon-* classes         → per-button gradient-badge overrides
 *     icon-audit, icon-loan-admin, icon-delete, icon-cashmemo
 *     icon-superadmin-folder, icon-newpost, icon-location
 *     icon-notify, icon-backup, icon-master, icon-bank, icon-hazira
 ...
 * ─────────────────────────────────────────────────────────────
 * IMPORTANT: this partial expects the following to be loaded on
 * the page (once, in the shared layout — not per-partial):
...
<!-- ══ SIDEBAR ════════════════════════════════════════════════
     ...
     JS:   assets/js/button-system.js  (click tone + ripple + sink)
══════════════════════════════════════════════════════════════ -->
    ...
    <div class="side-menu">
        ...
        <?php if ($_sbUserRole === 'admin'): ?>
            ...
            <div id="adminCorePanel" class="sb-folder-content">
                ...
                <div class="action-grid">
                    ...
                    <a href="../Inventory/inventory_dashboard.php" class="action-item">
                        <div class="round-3d-btn icon-audit"><i class="fas fa-microchip"></i></div>
                        <span class="label-3d">INV</span>
                    </a>

                    <a href="/Sales/" class="action-item">
                        <div class="round-3d-btn icon-loan-admin"><i class="fas fa-chart-pie"></i></div>
                        <span class="label-3d">Dashboard</span>
                    </a>

                    <a href="../my_sadakalo_full_admin/change_action_password.php" class="action-item">
                        <div class="round-3d-btn icon-delete"><i class="fas fa-user-lock"></i></div>
                        <span class="label-3d">Del Pass</span>
                    </a>

                    <a href="EmailReports/Sales" class="action-item">
                        <div class="round-3d-btn icon-cashmemo"><i class="fas fa-coins"></i></div>
                        <span class="label-3d">Sales</span>
                    </a>

                    <a href="SuperAdminDashboard.php" class="action-item">
                        <div class="round-3d-btn icon-superadmin-folder"><i class="fas fa-user-shield"></i></div>
                        <span class="label-3d">Super-Admin</span>
                    </a>

                    <a href="post.php" class="action-item">
                        <div class="round-3d-btn icon-newpost"><i class="fas fa-pen-nib"></i></div>
                        <span class="label-3d">New Post</span>
                    </a>

                    <a href="DB.php" class="action-item">
                        <div class="round-3d-btn icon-location"><i class="fas fa-server"></i></div>
                        <span class="label-3d">DB-chek</span>
                    </a>

                    <a href="sadakalo_popup_system/send_notification.php" class="action-item">
                        <div class="round-3d-btn icon-notify"><i class="fas fa-bullhorn"></i></div>
                        <span class="label-3d">Notify</span>
                    </a>

                    <a href="backup.php" class="action-item">
                        <div class="round-3d-btn icon-backup"><i class="fas fa-cloud-arrow-up"></i></div>
            ...
            <div class="action-grid">
                ...
                <?php if ($_sbUserRole === 'admin'): ?>
                    <a href="admin/master_control.php" class="action-item">
                        <div class="round-3d-btn icon-master"><i class="fas fa-gem"></i></div>
                        <span class="label-3d">মাস্টার হাব</span>
                    </a>
                <?php endif; ?>

                <a href="../Staff/index.php" class="action-item">
                    <div class="round-3d-btn icon-hazira"><i class="fas fa-user-clock"></i></div>
                    <span class="label-3d">স্টাফ রিপোর্ট</span>
                </a>

                <a href="/Accounts/Dps/" class="action-item">
                    <div class="round-3d-btn icon-bank"><i class="fas fa-landmark"></i></div>
                    <span class="label-3d">DPS</span>
                </a>

                <a href="Historys/" class="action-item">
                    <div class="round-3d-btn icon-history-admin"><i class="fas fa-receipt"></i></div>
                    <span class="label-3d">ক্যাশ-হিস্ট্রি</span>
                </a>

                <a href="/Accounts/Loan/" class="action-item">
                    <div class="round-3d-btn icon-loan"><i class="fas fa-money-check-dollar"></i></div>
                    <span class="label-3d">ঋণ ^ লোন</span>
                </a>

                <a href="History/" class="action-item">
                    <div class="round-3d-btn icon-historys"><i class="fas fa-clock-rotate-left"></i></div>
                    <span class="label-3d">Historys</span>
                </a>

                <a href="/Audit/" class="action-item">
                    <div class="round-3d-btn icon-super"><i class="fas fa-clipboard-check"></i></div>
                    <span class="label-3d">Audit Log</span>
                </a>

                <a href="Task/index.php" class="action-item">
                    <div class="round-3d-btn icon-task"><i class="fas fa-list-check"></i></div>
                    <span class="label-3d">Task</span>
                </a>

                <a href="BankCard/" class="action-item">
        ...
        <div class="action-grid">
            ...
            <a href="cash_sale.php" class="action-item">
                <div class="round-3d-btn icon-sales"><i class="fas fa-store"></i></div>
                <span class="label-3d">সেলস</span>
            </a>

            <a href="Expense/index.php" class="action-item">
                <div class="round-3d-btn icon-expense"><i class="fas fa-wallet"></i></div>
                <span class="label-3d">খরচ</span>
            </a>

            <a href="../Inventory/inventory_dashboard.php" class="action-item">
                <div class="round-3d-btn icon-inventory"><i class="fas fa-warehouse"></i></div>
                <span class="label-3d">ইনভেন্টরি</span>
            </a>

            <a href="daily_report.php" class="action-item">
                <div class="round-3d-btn icon-history"><i class="fas fa-calendar-day"></i></div>
                <span class="label-3d">হিস্ট্রি</span>
            </a>

            <a href="Customer/customers.php" class="action-item">
                <div class="round-3d-btn icon-customers"><i class="fas fa-address-card"></i></div>
                <span class="label-3d">কাস্টমার</span>
            </a>

            <a href="Suppliers/suppliers.php" class="action-item">
                <div class="round-3d-btn icon-suppliers"><i class="fas fa-truck-fast"></i></div>
                <span class="label-3d">সাপ্লায়ার</span>
            </a>

            <a href="Stock/index.php" class="action-item">
                <div class="round-3d-btn icon-stock"><i class="fas fa-layer-group"></i></div>
                <span class="label-3d">স্টক</span>
            </a>

            <a href="Profile/" class="action-item">
                <div class="round-3d-btn icon-settings"><i class="fas fa-sliders"></i></div>
                <span class="label-3d">সেটিংস</span>
            </a>

            <a href="logout.php" class="action-item">
                <div class="round-3d-btn icon-logout"><i class="fas fa-right-from-bracket"></i></div>
